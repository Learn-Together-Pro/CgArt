...
- [Architectural Modeling Tutorials and Tools](https://www.youtube.com/playlist?list=PL0LADxPpmXN4cdyX_Kg1Tmfj5fj_eVziZ) by [The CG Essentials](https://www.youtube.com/@TheCGEssentials) :mortar_board: :movie_camera: ( _blender_ ) ( _modeling_ ) ( _interior_ ) : course on architectural modeling and texturing
...
- [Character Creation and Rigging](https://www.youtube.com/playlist?list=PL08jQWquPV8UnhqBXBOv4DjYLsTPwCHiO) by [SouthernShotty](https://www.youtube.com/@SouthernShotty) :mortar_board: :movie_camera: ( _modeling_character_ ) ( _animation_ ) ( _rigging_ ) ( _blender_ ) ( _level_1_ )
...
- [Blender Physics Simulation](https://www.youtube.com/playlist?list=PLsGl9GczcgBustxQs2JcnSb0Qxnnb7rWC) by [Ryan King Art](https://www.youtube.com/@RyanKingArt) :mortar_board: :movie_camera: ( _animation_ ) ( _physics_ ) ( _blender_ ) ( _level_2_ )

## Aesthetics: Cinematography - 2

( _animation_ ) ( _aesthetics_ ) ( _cinematography_ ) ( _blender_ )
...
- [Lighting Course](https://www.youtube.com/playlist?list=PLjEaoINr3zgH9vCr47kSS5W8PEJBNIiwK) by [Andrew Price](https://www.youtube.com/@blenderguru) :mortar_board: :movie_camera: ( _light_ ) ( _blender_ ) ( _level_0_ )
- [Mastering Light](https://www.youtube.com/playlist?list=PLeb33PCuqDdfdbDKEShGuYL1PizRly7MW) by [community]() :movie_camera:  ( _light_ ) ( _blender_ ) ( _level_0_ )
...
- [Understanding Composition](https://www.picturecorrect.com/the-ultimate-guide-to-understanding-composition/) by [Andrew Price](https://www.youtube.com/@blenderguru) :page_facing_up: ( _composition_ )
- [Primary, Secondary And Tertiary Shapes](https://web.archive.org/web/20201207145016/http://www.neilblevins.com/cg_education/primary_secondary_and_tertiary_shapes/primary_secondary_and_tertiary_shapes.htm) by [Neil Blevins](https://www.youtube.com/@ArtOfSoulburn/videos) :page_facing_up: ( _composition_ )
...
- [Composition for Artists](https://www.youtube.com/playlist?list=PLV2X3tgajVlHEWoxhxHBV5JyU7R80LT9R) by [Sycra](https://www.youtube.com/@Sycra) :mortar_board: :movie_camera: ( _composition_ )
...
- [Jacob](https://www.youtube.com/@InLightVFX) :open_file_folder: :movie_camera: ( _blender_ ) ( _animation_vfx_ ) : tutorials on visual effects
- [LightArchitect](https://www.youtube.com/@LightArchitect) :open_file_folder: :movie_camera: ( _blender_ ) ( _animation_vfx_ ) ( _environment_ ) : mostly visual effects and environment
...
- ( _2d_ ) - 2d graphics
- ( _3d_ ) - 3d graphics
- ( _aesthetics_ ) - either colors theory or composition theory
- ( _material_ ) - materials and shaders
- ( _modeling_ ) - modeling
- ( _modeling_sculpting_ ) - modeling with help of sculpting
- ( _modeling_hardsurface_ ) - modeling hardsurface
- ( _modeling_lowpoly_ ) - modeling low polygon models
- ( _modeling_character_ ) - modeling a character
- ( _modeling_grease_pencil_ ) - using grease pencil
- ( _modeling_curves_ ) - modeling with curves and splines
- ( _modeling_kitbashing_ ) - kit-bashing from prefabricated parts
- ( _fast_ ) - fast art process
- ( _retopology_ ) - retopology / retexturing / baking
- ( _reference_ ) - modeling and reproducing by reference
- ( _light_ ) - light
- ( _environment_ ) - environment
- ( _texturing_ ) texturing
- ( _interior_ ) interior design
- ( _composition_ ) - composition theory
- ( _color_ ) - color theory
- ( _drawing_ ) - teach to draw and paint
- ( _productivity_ ) - productivity optimization
- ( _assets_management_ ) - assets management
- ( _addon_ ) - addons
- ( _render_time_ ) - render time optimization
- ( _ai_ ) - AI-driven design
- ( _video_editing_ ) - video editing
- ( _cinematography_ ) - camera / cinematography
- ( _baking_ ) - baking
- ( _animation_ ) - all kind of animation
- ( _animation_product_ ) - product animation
- ( _animation_vfx_ ) - visual effects
- ( _rigging_ ) - rigging for animation
- ( _physics_ ) - physics for animation
- ( _photogrammetry_ ) - create maps or 3D models from photo
